...
namespace SGFastFlyers.DataAccessLayer
{
    ...
    public class DataInitializer : CreateDatabaseIfNotExists<SGDbContext>
    {
        ...
        protected override void Seed(SGDbContext context)
        {
            ...
            {
            new Order{FirstName="Carson",LastName="Alexander",EmailAddress="ACarson@email.com", PhoneNumber="0400000000", Quantity=10, IsPaid=false},
            new Order{FirstName="Meredith",LastName="Alonso",EmailAddress="AMeredith@email.com", PhoneNumber="0411111111", Quantity=34, IsPaid=false},
            new Order{FirstName="Arturo",LastName="Anand",EmailAddress="AArturo@email.com", PhoneNumber="0422222222", Quantity=980, IsPaid=false},
            new Order{FirstName="Gytis",LastName="Barzdukas",EmailAddress="BGytis@email.com", PhoneNumber="0433333333", Quantity=200, IsPaid=false},
            new Order{FirstName="Yan",LastName="Li",EmailAddress="LYan@email.com", PhoneNumber="0444444444", Quantity=13000, IsPaid=false},
            new Order{FirstName="Peggy",LastName="Justice",EmailAddress="JPeggy@email.com", PhoneNumber="0455555555", Quantity=1200, IsPaid=false},
            new Order{FirstName="Laura",LastName="Norman",EmailAddress="NLaura@email.com", PhoneNumber="0466666666", Quantity=3090, IsPaid=false},
