...
namespace SGFastFlyers.DataAccessLayer
{
    ...
    public class DataInitializer : CreateDatabaseIfNotExists<SGDbContext>
    {
        ...
        protected override void Seed(SGDbContext context)
        {
            ...
            new Order{FirstName="Meredith",LastName="Alonso",EmailAddress="AMeredith@email.com", PhoneNumber="0411111111", Quantity=34, IsPaid=true},
            new Order{FirstName="Arturo",LastName="Anand",EmailAddress="AArturo@email.com", PhoneNumber="0422222222", Quantity=980, IsPaid=true},
            ...
            new Order{FirstName="Peggy",LastName="Justice",EmailAddress="JPeggy@email.com", PhoneNumber="0455555555", Quantity=1200, IsPaid=true},
